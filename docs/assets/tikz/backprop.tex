...
\begin{tikzpicture}
    ...
    \node[blue!90!black] at (2.7,1.5) {$z_1^{[1]}$};
    \node[blue!90!black] at (3.5,1.5) {$a_1^{[1]}$};
    \node[blue!40!black] at (2.5,-4.5) {$z_6^{[1]}$};
    \node[blue!40!black] at (3.5,-4.5) {$a_6^{[1]}$};

    \node[green!90!black] at (5.7,1.5) {$z_1^{[2]}$};
    \node[green!90!black] at (6.5,1.5) {$a_1^{[2]}$};
    \node[green!40!black] at (5.5,-4.5) {$z_6^{[2]}$};
    \node[green!40!black] at (6.5,-4.5) {$a_6^{[2]}$};

    \node[orange!80!black] at (8.7,0) {$z_1^{[3]}$};
    \node[orange!80!black] at (9.5,0) {$a_1^{[3]}$};
    \node[orange!40!black] at (8.6,-3) {$z_3^{[3]}$};
    \node[orange!40!black] at (9.35,-3) {$a_3^{[3]}$};
    ...
    \node [rotate=0,fill=yellow!50,draw,thick, minimum height=1cm, minimum width=2cm, decorate, decoration={random steps,segment length=3pt,amplitude=1pt}] at (9.35,1.25) {Backpropagation};
